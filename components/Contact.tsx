      ...
      <div className="relative z-10" style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center" style={{ gap: 64, marginBottom: 72 }}>
          <div>
            ...
            <p className="reveal reveal-delay-2 font-light" style={{ fontSize: 16, lineHeight: 1.9, color: "var(--muted)" }}>
          ...
          <div className="img-reveal overflow-hidden" style={{ borderRadius: 16 }}>
            <Image
              src="/img/contact.png"
              alt="Welcoming handshake — let's start the conversation"
              width={600}
              height={400}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{ gap: 100 }}>
          ...
          {/* Right — Form */}
          <form ref={formRef} onSubmit={handleSubmit} className="reveal reveal-delay-2 flex flex-col gap-5">
