  ...
  return (
    <section className="relative flex flex-col justify-center" style={{ minHeight: "100vh", overflow: "hidden" }}>
      ...
      <div className="absolute top-0 left-0 w-full h-full"
        style={{ background: "linear-gradient(to bottom, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.5) 40%, rgba(0,0,0,0.7) 100%)", zIndex: 1 }} />
      ...
      <div className="relative w-full flex flex-col items-center justify-center text-center"
        ...
        <div style={{
          ...
          {/* Renaissance headline — THE statement */}
          <h1 style={{
            ...
            Welcome to the Renaissance of Data-Driven Optimization
          </h1>
        </div>
        ...
        <div style={{
          ...
          <div style={{ width: 24, height: 40, borderRadius: 12, border: "1.5px solid rgba(245,242,235,0.3)", display: "flex", justifyContent: "center", paddingTop: 8 }}>
            <motion.div
              animate={{ y: [0, 8, 0] }}
              transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
              style={{ width: 3, height: 8, borderRadius: 2, background: "rgba(245,242,235,0.5)" }}
            />
          </div>
        </div>
      </div>
